...
echo "📁 Création des dossiers Let's Encrypt..."
...
echo "0 12 * * * /usr/bin/certbot renew --quiet --deploy-hook \"docker-compose -f $(pwd)/docker-compose.yml restart nginx\"" | sudo crontab -
